...
//            Schedule(id = 1, idCourt = 1, idUser = 1, date = "2021-10-10", hourStart = "10:00", hourEnd = "11:00"),
//            Schedule(id = 2, idCourt = 2, idUser = 2, date = "2021-10-10", hourStart = "11:00", hourEnd = "12:00")
//        )
//        Mockito.`when`(service.list(SortDir.ASC, null)).thenReturn(expectedSchedules)
//
...
//
//        val result = controller.getScheduleById()
//
...
//        )
//        Mockito.`when`(service.list(courtId)).thenReturn(expectedSchedules)
//
//        val result = controller.list(courtId, null)
//
//        assertEquals(expectedSchedules, result)
//    }
//
